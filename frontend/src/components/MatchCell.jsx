...
const MatchCell = ({ match, showHT, filterColor, onClick }) => {
  ...
  return (
    <button
      onClick={onClick}
      className={`w-full h-full p-0.5 text-[9px] leading-tight bg-gray-900 hover:bg-gray-800 transition-colors cursor-pointer flex flex-col items-center justify-center ${filterColor}`}
