/**
 * AnalysisPage.jsx - Versão com Análise Preditiva
 * 
 * Inclui nova aba de análise preditiva que identifica padrões
...
export default function AnalysisPage() {
  ...
  const handlePredictiveAnalysis = async () => {
    ...
    try {
      ...
      console.log('Analisando padrões preditivos para:', {
        market: selectedMarket,
        reference_date: referenceDate,
        lookback_days: lookbackDays,
        top_n: 5
      ...
      console.log('Análise diária:', dailyResponse.data);
      ...
      setError(errorMsg);
      console.error('Erro ao analisar padrões preditivos:', err);
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                {loading && activeTab === 'predictive' ? 'Analisando...' : 'Análise Preditiva'}
              </button>
            </div>
          </div>
